            ...
            <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
                <form action="/register" method="POST" id="registration-form">
                    ...
                    <div class="form-group">
                        ...
                        <input name="password" id="password-register" class="form-control  @error('password') is-invalid @enderror" type="password"
                    ...
                    <div class="form-group">
                        ...
                        <input name="password_confirmation" id="password-register-confirm" class="form-control  @error('password_confirmation') is-invalid @enderror"
                               type="password"
